...
console.log(getFullName(person40)); // Test test
...
class Employee1 extends Person3 {
    ...
    //overwrite
    describe(): string {
        return `${super.describe()} from parent - describe test`;
    }
}
...
let employee = new Employee1('test', 'Test', 'Web Developer');
...
let person2 = new Person2(25, 'test', 'Test');
...
let test = new Person("123", "test", " Test");
console.log(">> check class: ", test.getFullName())
...
// console.log(">>> check add new: ", addNew(6, 9), addNew(" test", " & Test"))
...
console.log(Greet("Xin chao", "Test &", "test")); // returns "Hello Steve, Bill!"
